...
**Implemented:** Base64, Baconian, PAM-5 dibit.  
...
| **Hexadecimal** | 16 (0–9A–F) | 4 | Reference | Nibble encoding |
...
| **Manchester** | 2 (mid-bit transition) | 10BASE-T, RFID | Reference | 0 = ↑↓, 1 = ↓↑ per bit period |
...
1. Hex / Base32 (simple radix, puzzle frequency)
2. Manchester (teaching line coding)
3. 4D-PAM5 trellis (PHY-accurate, high effort)
