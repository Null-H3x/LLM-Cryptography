...
**Implemented catalog:** 48 variants — see [`README.md`](README.md).  
...
|--------|------|-----------------|--------|----------|
| **Pigpen** | Symbol grid | 26 letters → Masonic cell symbols | Reference | **P1** |
...
| Cipher | Type | Formula / model | Status | Priority |
|--------|------|-----------------|--------|----------|
| **Scytale** | Cylinder transposition | Read every \(d\)th character on staff diameter \(d\) | Reference | **P1** |
...
| Cipher | Type | Formula / model | Status | Priority |
|--------|------|-----------------|--------|----------|
| **Nihilist** | Polybius + numeric key | \((r,c) + k_i \mod 10\) per digit pair | Reference | **P1** |
...
| Line encoding | **PAM-5**, Base64, Baconian |
